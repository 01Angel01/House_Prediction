...
# installed.
TCL_PREFIX='D:/Folder/New_folder/WOLF/Dibimbing/Machine Learning Engineer/Baru/Day 26/Assignment_2/Assignment/mlops\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Folder/New_folder/WOLF/Dibimbing/Machine Learning Engineer/Baru/Day 26/Assignment_2/Assignment/mlops\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Folder/New_folder/WOLF/Dibimbing/Machine Learning Engineer/Baru/Day 26/Assignment_2/Assignment/mlops\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Folder/New_folder/WOLF/Dibimbing/Machine Learning Engineer/Baru/Day 26/Assignment_2/Assignment/mlops\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Folder/New_folder/WOLF/Dibimbing/Machine Learning Engineer/Baru/Day 26/Assignment_2/Assignment/mlops\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Folder/New_folder/WOLF/Dibimbing/Machine Learning Engineer/Baru/Day 26/Assignment_2/Assignment/mlops\Library\lib\tclstub86.lib'
